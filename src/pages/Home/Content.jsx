...
import GetYouTubeEmbedInfo from "../../utils/getYoutubeEmbedInfo";
...
const Content = ({ connectRef, contentRef }) => {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const fetchedContent = await axios.get(
                "https://api.github.com/repos/Aakashedits/Portfolio-data/contents/New%20Text%20Document.json"
            );
    ...
    const videoInfo = GetYouTubeEmbedInfo(selectedItem?.video);
        ...
        <div className="relative w-full bg-secondary-dark z-20 py-12 px-12 3xl:py-20 sm:px-20 2xl:px-40 flex items-center gap-20 3xl:gap-40 text-white min-h-screen">
                ...
                screenWidth >= 1280 && (
                    ...
                    <div className="border border-slate-500 rounded-lg bg-primary-dark p-8 w-[40%] sticky top-1/2 -translate-y-1/2 h-fit">
                        ...
                        <div
                            className={
                                videoInfo.isShort
                                    ? "aspect-9/16 w-full max-w-50 2xl:max-w-75 mx-auto"
                                    : "aspect-video w-full"
                            }
                        >
                    ...
                    <div className="fixed z-50 flex justify-center items-center inset-0 w-screen h-screen m-auto bg-black/25 backdrop-blur-3xl">
                        ...
                        <div className="w-screen mx-6 sm:mx-10 flex flex-col sm:flex-row sm:gap-6 bg-primary-dark">
                            ...
                            <div
                                className={
                                    videoInfo.isShort
                                        ? "aspect-9/16 w-full sm:w-auto sm:h-[80vh]"
                                        : "aspect-video w-full sm:w-[60%]"
                                }
                            >
...

            {
                !connectVisible && contentVisible && (
                    ...
                    <button
                        onClick={handleClick}
                        className="cursor-pointer fixed bottom-4 left-0 right-0 mx-auto w-fit flex justify-center items-center gap-2 rounded-full px-6 py-1 lg:py-2 bg-slate-900/25 animate-bounce text-white backdrop-blur-3xl z-10"
                    >
                        Connect with me
